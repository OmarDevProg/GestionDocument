    ...
    <div class="flex-1 flex flex-col overflow-hidden bg-white">
     ...
     ORDER  BY lh.login_time DESC"
        ...
        <div class="max-w-6xl mx-auto mt-10">
            <h1 class="text-3xl font-bold mb-6">Historique de Connexion</h1>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left">Heure de Connexion</th>
                        <th class="px-6 py-3 text-left">Adresse IP</th>
                        <th class="px-6 py-3 text-left">Navigateur</th>
                    </tr>
                    </thead>
                    ...
                    <?php foreach ($logins as $l): ?>
                        <tr>
                            <td class="px-6 py-4 font-medium">
                                <?= htmlspecialchars($l['firstname'].' '.$l['lastname']) ?>
                            </td>
                            <td class="px-6 py-4"><?= htmlspecialchars($l['email']) ?></td>
                            <td class="px-6 py-4"><?= htmlspecialchars($l['login_time']) ?></td>
                            <td class="px-6 py-4"><?= htmlspecialchars($l['ip_address']) ?></td>
